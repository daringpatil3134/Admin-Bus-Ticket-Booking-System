    ...
    <main id="container">
        <section id="searched-route">
            <ul>
                ...
                <li class="searched-route-item">
                    <?php echo $source; ?> <span class="arrow">&rarr;</span>
                    ...
                    <div class="searched-result-item">
                        ...
                        <div class="booking-desc">
                            ...
                            echo $bus_no; ?>" data-seats="<?php echo $booked_seats; ?>"
                                data-routeid="<?php echo $route_id; ?>" data-amount="<?php echo $booking_amount; ?>"
                                data-source="<?php echo $source; ?>" data-destination="<?php echo $destination; ?>">
                                Select Seats
                            </button>
                        </div>
                    </div>
        ...
        <footer>
            <p>
                ...
                <?php echo date('Y'); ?> - Simple Bus Ticket Booking System | Made with &#10084;&#65039; by Pranav Patil
            </p>
        </footer>
    </main>
