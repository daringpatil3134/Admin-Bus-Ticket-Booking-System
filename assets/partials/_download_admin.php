<?php
    ...
    if(isset($_GET["pnr"]))
    {
        ...
        $admin_name = get_from_table($conn, "bookings", "booking_id", $pnr, "admin_name");
...
<div class="container">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Booked By:</b></em></h4></td>

                            <td class="col-md-6 text-center"><?php echo $admin_fullname," (",$admin_name,")"; ?></td>
                        </tr>
    ...
    <div style="margin-top: -3.15rem; text-align: right;">
            <a href="http://localhost/SimpleBusTicket-PHP/admin/booking.php" class="btn btn-primary">Go Back</a>
    </div>
