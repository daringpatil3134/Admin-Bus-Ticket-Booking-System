<?php
    ...
    if($row = mysqli_fetch_assoc($result))
    {
        ...
        $admin_img_path = '../assets/user/'.$row["pp"];
    }
?>
...
<!-- <header>
    ...
    <main id="container">
        <div id="sidebar">
            <h4><i class="fas fa-bus"></i> MSRCTC</h4>
            <div>
                <img class="adminDp" src="<?php echo $admin_img_path; ?>" height="125px" alt="Admin Profile Pic">
                <p>
                    <?php  echo '@'.$admin_name;  ?>
                </p>
            ...
            <ul id="options">
                ...
                <li class="option <?php if($page=='queries'){ echo 'active';}?>">
                    <a href="./queries.php">
                    <i class="fas fa-exclamation-circle"></i> Queries
                    </a>
                </li>
