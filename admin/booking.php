            ...
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if(!$booking_exists)
                {
                    ...
                    $sql = "INSERT INTO `bookings` (`customer_id`, `route_id`, `customer_route`, `booked_amount`, `booked_seat`,`admin_name`, `booking_created`) VALUES ('$customer_id', '$route_id','$route', '$amount', '$booked_seat', '$admin_name', current_timestamp());";
                ...
                <div id="booking-results">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo "../assets/partials/_download_admin.php?pnr=",$pnr?>" class="btn btn-primary">Print</a>
