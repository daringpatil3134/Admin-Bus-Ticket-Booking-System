                ...
                <div id="admin">
                    <?php 
                        ...
                        foreach($adminData as $admin)
                        {
                            ...
                            if($adminArr["admin_id"] == $admin_id) 
                                continue;
                            $username = $adminArr["admin_fullname"];
                            $img_path = '../assets/user/'.$adminArr["pp"];
                        ?>
                            <div class="info-box admin-item" style="width: 20%;">
                                <img src="<?php echo $img_path; ?>" height="100px" alt="Profile Pic">
